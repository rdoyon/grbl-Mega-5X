...
#ifdef CPU_MAP_MEGA_LITE_2560_BOARD // (Arduino Mega 2560) with MegaLite Board
#include "nuts_bolts.h"
...
#endif
#define STEP_BIT_0 2  // X Step - Pin D24 - PA2
#define STEP_BIT_1 3  // Y Step - Pin D25 - PA3
#define STEP_BIT_2 4  // Z Step - Pin D26 - PA4
#if N_AXIS > 3
#define STEP_BIT_3 5 // Axis number 4 Step - Pin D27 - PA5
#endif
#if N_AXIS > 4
#define STEP_BIT_4 6 // Axis number 5 Step - Pin D28 - PA6
#endif
#if N_AXIS > 5
#define STEP_BIT_5 7 // Axis number 6 Step - Pin D29 - PA7
#endif
#define _STEP_BIT(i) STEP_BIT_##i
#define STEP_BIT(i) _STEP_BIT(i)
#define STEP_DDR(i) _DDR(STEP_PORT_##i)
...
#endif
#define DIRECTION_BIT_0 7 // X Dir - Pin D30 - PC7
#define DIRECTION_BIT_1 6 // Y Dir - Pin D31 - PC6
#define DIRECTION_BIT_2 5 // Z Dir - Pin D32 - PC5
#if N_AXIS > 3
#define DIRECTION_BIT_3 4 // Axis number 4 Step - Pin D33 - PC4
#endif
#if N_AXIS > 4
#define DIRECTION_BIT_4 3 // Axis number 5 Step - Pin D34 - PC3
#endif
#if N_AXIS > 5
#define DIRECTION_BIT_5 2 // Axis number 6 Step - Pin D35 - PC2
#endif
#define _DIRECTION_BIT(i) DIRECTION_BIT_##i
#define DIRECTION_BIT(i) _DIRECTION_BIT(i)
#define DIRECTION_DDR(i) _DDR(DIRECTION_PORT_##i)
...
#endif
#define STEPPER_DISABLE_BIT_0 7 // X Enable - Pin D13 - PB7
#define STEPPER_DISABLE_BIT_1 7 // Y Enable - Pin D13 - PB7
#define STEPPER_DISABLE_BIT_2 7 // Z Enable - Pin D13 - PB7
#if N_AXIS > 3
#define STEPPER_DISABLE_BIT_3 7 // Axis number 4 Step - Pin D13 - PB7
#endif
#if N_AXIS > 4
#define STEPPER_DISABLE_BIT_4 7 // Axis number 5 Step - Pin D13 - PB7
#endif
#if N_AXIS > 5
#define STEPPER_DISABLE_BIT_5 7 // Axis number 5 Step - Pin D13 - PB7
#endif
#define STEPPER_DISABLE_BIT(i) STEPPER_DISABLE_BIT_##i
#define STEPPER_DISABLE_DDR(i) _DDR(STEPPER_DISABLE_PORT_##i)
#define STEPPER_DISABLE_PORT(i) _PORT(STEPPER_DISABLE_PORT_##i)
...
#endif
#define MIN_LIMIT_BIT_0 4 // X Limit Min - Pin D10 - PB4
#define MIN_LIMIT_BIT_1 5 // Y Limit Min - Pin D11 - PB5
#define MIN_LIMIT_BIT_2 6 // Z Limit Min - Pin D12 - PB6
#if N_AXIS > 3
#define MIN_LIMIT_BIT_3 0 // Axis number 4 : Pin D53 - PB0
#endif
#if N_AXIS > 4
#define MIN_LIMIT_BIT_4 1 // Axis number 5 : Pin D52 - PB1
#endif
#if N_AXIS > 5
#define MIN_LIMIT_BIT_5 2 // Axis number 6 : Pin D51 - PB2
#endif
#define _MIN_LIMIT_BIT(i) MIN_LIMIT_BIT_##i
#define MIN_LIMIT_BIT(i) _MIN_LIMIT_BIT(i)
#define MIN_LIMIT_DDR(i) _DDR(MIN_LIMIT_PORT_##i)
...
#define SPINDLE_ENABLE_BIT      3 // MEGA2560 Digital Pin 6 - D6 - PH3
#define SPINDLE_DIRECTION_DDR   DDRE
#define SPINDLE_DIRECTION_PORT  PORTE
#define SPINDLE_DIRECTION_BIT   3 // MEGA2560 Digital Pin 5 - D5 - PE3

// Define flood and mist coolant enable output pins.
#define COOLANT_FLOOD_DDR   DDRH
#define COOLANT_FLOOD_PORT  PORTH
#define COOLANT_FLOOD_BIT   5 // MEGA2560 Digital Pin 8 - D8 - PH5
#define COOLANT_MIST_DDR    DDRH
#define COOLANT_MIST_PORT   PORTH
#define COOLANT_MIST_BIT    6 // MEGA2560 Digital Pin 9 - D9 - PH6

/*  Pas de Digital Output Control
// Define M62 - M65 Digital Output Control ports
// D16 D17 D23 D25
#define DIGITAL_OUTPUT_DDR_0  DDRH
#define DIGITAL_OUTPUT_PORT_0 PORTH
...
#define CONTROL_PIN       PINK
#define CONTROL_PORT      PORTK
#define CONTROL_RESET_BIT         0  // Pin A8 - PK0
#define CONTROL_FEED_HOLD_BIT     1  // Pin A9 - PK1
#define CONTROL_CYCLE_START_BIT   2  // Pin A10 - PK2
#define CONTROL_SAFETY_DOOR_BIT   3  // Pin A11 - PK3
#define CONTROL_INT       PCIE2  // Pin change interrupt enable pin
#define CONTROL_INT_vect  PCINT2_vect
#define CONTROL_PCMSK     PCMSK2 // Pin change interrupt register
#define CONTROL_MASK      ((1<<CONTROL_RESET_BIT)|(1<<CONTROL_FEED_HOLD_BIT)|(1<<CONTROL_CYCLE_START_BIT)|(1<<CONTROL_SAFETY_DOOR_BIT))
...
#define PROBE_PIN       PINK
#define PROBE_PORT      PORTK
#define PROBE_BIT       7  // MEGA2560 Analog Pin 15 - A15 - PK7
#define PROBE_MASK      (1<<PROBE_BIT)
...
// TIMER2 (controls pin D10,  D9);      => Timer2 is used by analog output or spindle PWM on D9
// TIMER3 (controls pin  D5,  D3,  D2); => Timer3 is used by sleep.c
// TIMER4 (controls pin  D8,  D7,  D6); => Timer4 is used by analog output or spindle PWM on D8, D7 or D6
// TIMER5 (controls pin D46, D45, D44); => Timer5 is unused by grbl-Mega-5X. It's possible to add 
//                                         PWM capability to ports D44 (RAMPS AUX-2), D45 (RAMPS AUX-4). 
//                                         D46 is not available for PWM because it's used by Z step.
// Arduino pin number and the corresponding register for controlling the duty cycle :
...
// Set Timer up to use TIMER4B which is attached to Digital Pin 7 - PH4
#define SPINDLE_PWM_MAX_VALUE     1024.0 // Translates to about 1.9 kHz PWM frequency at 1/8 prescaler
#ifndef SPINDLE_PWM_MIN_VALUE
#define SPINDLE_PWM_MIN_VALUE   1   // Must be greater than zero.
#endif
...
// Define spindle output pins. D7  - PH4
#define SPINDLE_PWM_DDR   DDRH
#define SPINDLE_PWM_PORT  PORTH
#define SPINDLE_PWM_BIT   4 // MEGA2560 Digital Pin 7 -  D7  - PH4
...
#else
#error "OUTPUT_PWM_ON_D9 or OUTPUT_PWM_ON_D8 or OUTPUT_PWM_ON_D6  or OUTPUT_PWM_ON_D7 must be defined in config.h with the USE_OUTPUT_PWM option!"
#endif

#endif // USE_OUTPUT_PWM

#endif // CPU_MAP_MEGA_LITE_2560_BOARD
