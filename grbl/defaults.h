...
#define STEP_REVS_AXIS1 200    // Moteurs à 200 pas par tour
#define UNIT_PER_REV_AXIS1 2.0 // 2mm
#define DEFAULT_AXIS1_STEPS_PER_UNIT 90.500 //(MICROSTEPS_AXIS1*STEP_REVS_AXIS1/UNIT_PER_REV_AXIS1) // 400
#define MICROSTEPS_AXIS2 4     // Microstepping = 1/4 pas
#define STEP_REVS_AXIS2 200    // Moteurs à 200 pas par tour
#define UNIT_PER_REV_AXIS2 2.0 // 2mm
#define DEFAULT_AXIS2_STEPS_PER_UNIT 90.500 // (MICROSTEPS_AXIS2*STEP_REVS_AXIS2/UNIT_PER_REV_AXIS2)
#define MICROSTEPS_AXIS3 4     // Microstepping = 1/4 pas
#define STEP_REVS_AXIS3 200    // Moteurs à 200 pas par tour
#define UNIT_PER_REV_AXIS3 2.0 // 2mm
#define DEFAULT_AXIS3_STEPS_PER_UNIT 200.236 // (MICROSTEPS_AXIS3*STEP_REVS_AXIS3/UNIT_PER_REV_AXIS3)
#define STEP_MAX_FREQUENCY 5000
#define SECONDS_PER_MINUTE 60
#define DEFAULT_AXIS1_MAX_RATE 12700.0 // 9000 mm/min = 9000/60 = 150 mm/sec
//#define DEFAULT_AXIS1_MAX_RATE  (STEP_MAX_FREQUENCY/DEFAULT_AXIS1_STEPS_PER_UNIT*SECONDS_PER_MINUTE) // 3000
#define DEFAULT_AXIS2_MAX_RATE 12700.0 // 9000 mm/min = 9000/60 = 150 mm/sec
//#define DEFAULT_AXIS2_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS2_STEPS_PER_UNIT*SECONDS_PER_MINUTE)
#define DEFAULT_AXIS3_MAX_RATE 2000.0  //  300 mm/min =  300/60 =   5 mm/sec
//#define DEFAULT_AXIS3_MAX_RATE  (STEP_MAX_FREQUENCY/DEFAULT_AXIS3_STEPS_PER_UNIT*SECONDS_PER_MINUTE)
#define DEFAULT_AXIS1_ACCELERATION (200.0*60*60) //(50.0*60*60) // 300*60*60 mm/min^2 = 300 mm/sec^2
#define DEFAULT_AXIS2_ACCELERATION (200.0*60*60) //(50.0*60*60) // 300*60*60 mm/min^2 = 300 mm/sec^2
#define DEFAULT_AXIS3_ACCELERATION (100.0*60*60) // (50.0*60*60) // 100*60*60 mm/min^2 = 100 mm/sec^2
#define DEFAULT_AXIS1_MAX_TRAVEL 1265 // mm
#define DEFAULT_AXIS2_MAX_TRAVEL 1265 // mm
#define DEFAULT_AXIS3_MAX_TRAVEL 175 // mm
#if N_AXIS > 3
#if AXIS_4_NAME != AXIS_1_NAME && AXIS_4_NAME != AXIS_2_NAME && AXIS_4_NAME != AXIS_3_NAME
#define DEFAULT_AXIS4_STEPS_PER_UNIT 8.888889 // Direct drive : (200 pas par tours * 1/16 microsteps)/360°
#define DEFAULT_AXIS4_MAX_RATE 1440 // °/mn
...
#endif
#endif
#define DEFAULT_SPINDLE_RPM_MAX 24000 // rpm
#define DEFAULT_SPINDLE_RPM_MIN 500.0 // rpm
#ifdef SEPARATE_SPINDLE_LASER_PIN
#define DEFAULT_LASER_MAX 100
#define DEFAULT_LASER_MIN 1
#endif
...
#define DEFAULT_STATUS_REPORT_MASK 115 // MPos enabled
#define DEFAULT_JUNCTION_DEVIATION 0.02 // mm
#define DEFAULT_ARC_TOLERANCE 0.002 // mm
#define DEFAULT_REPORT_INCHES 0 // false
#define DEFAULT_INVERT_ST_ENABLE 0 // false
